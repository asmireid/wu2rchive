...
<Admonition type="danger" icon="🍅" title="舞台少女は日々進化中">
  <span style={{fontSize: '72px', fontWeight: 'bold'}}>ア</span>
  <span style={{fontSize: '48px', fontWeight: 'bold'}}>タ</span>
  ...
  <span style={{fontSize: '48px', fontWeight: 'bold'}}>生</span>
  <span style={{fontSize: '72px', fontWeight: 'bold'}}>産</span>
</Admonition>
