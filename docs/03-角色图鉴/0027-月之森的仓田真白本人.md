...
<Admonition type="danger" icon="🍅" title="舞台少女は日々進化中">
  <span style={{fontSize: '32px'}}>ア</span>
  <span style={{fontSize: '24px'}}>タ</span>
  <span style={{fontSize: '16px'}}>シ</span>
  <span style={{fontSize: '16px'}}>再</span>
  <span style={{fontSize: '24px'}}>生</span>
  <span style={{fontSize: '32px'}}>産</span>
</Admonition>
